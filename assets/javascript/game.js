...
const rawGithubLocation = "https://raw.githubusercontent.com/semlak/Hangman-Game/master/"
...
var HangmanApp = class {
	...
	playSong() {
		...
		if (audioElement.paused) {
			var audioURL = GameData.songs[Math.floor(Math.random()*GameData.songs.length)];
	...
	playQuoteAudio() {
		var itemData = GameData.words[this.word];
		var wordHasAudioElement = typeof itemData !== "undefined" && typeof itemData.audio !== "undefined";
	...
	updateQuote() {
		...
		if (typeof GameData.words[me.word] !== "undefined") {
			var itemData = GameData.words[me.word]
